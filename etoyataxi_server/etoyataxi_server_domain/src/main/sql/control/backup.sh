...
NOW=$(date +"%m-%d-%Y")
echo "Begin pgdump $NOW" >> /usr/share/ostdlabs/etoyataxi/etoyataxi-api/sql/backup/logs/dump-$NOW.log
pg_dump -d$db -h$db_host -U$db_user | gzip > "/usr/share/ostdlabs/etoyataxi/etoyataxi-api/sql/backup/backup-$NOW.sql.gz" 2>> /usr/share/ostdlabs/etoyataxi/etoyataxi-api/sql/backup/logs/dump-$NOW.log
echo "Finished pgdump $NOW" >> /usr/share/ostdlabs/etoyataxi/etoyataxi-api/sql/backup/logs/dump-$NOW.log
